...
const FPS = 60;
const POWERUP_CHANCE = 100; // 100% chance to spawn a powerup on asteroid destruction
const POWERUP_LIFETIME = 480;
const POWERUP_EFFECT_DURATION = 10000;
const BASE_FIRE_DELAY = -999; // Negative delay for instant firing
const RAPID_FIRE_DELAY = -999; // Negative delay for instant firing
